========================================================================
    동적 연결 라이브러리 : Chapter(8-3 HDH_DLIB_Math) 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 Chapter(8-3 HDH_DLIB_Math) DLL을 만들었습니다.

Chapter(8-3 HDH_DLIB_Math) 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


Chapter(8-3 HDH_DLIB_Math).vcxproj
...
Chapter(8-3 HDH_DLIB_Math).vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 Chapter(8-3 HDH_DLIB_Math).pch와
