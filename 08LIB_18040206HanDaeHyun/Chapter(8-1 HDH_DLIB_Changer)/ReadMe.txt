========================================================================
    동적 연결 라이브러리 : Chapter(8-1 HDH_DLIB_Changer) 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 Chapter(8-1 HDH_DLIB_Changer) DLL을 만들었습니다.

Chapter(8-1 HDH_DLIB_Changer) 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


Chapter(8-1 HDH_DLIB_Changer).vcxproj
...
Chapter(8-1 HDH_DLIB_Changer).vcxproj.filters
...
Chapter(8-1 HDH_DLIB_Changer).cpp
    기본 DLL 소스 파일입니다.
...
Chapter(8-1 HDH_DLIB_Changer).rc
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 Chapter(8-1 HDH_DLIB_Changer).pch와
